...
exports.randomId = ({ length, attach }) => {
	const strArr = [
		'a',
		'b',
		'c',
...
exports.randomColor = () => ('#' + ((Math.random() * 0xffffff) << 0).toString(16) + '000000').slice(0, 7);

exports.objToArr = (obj, arrType = '_1D_Arr') => {
	let arr = [];
	switch (arrType) {
		case '_2D_Arr':
			for (let prop in obj) {
...
exports.arrToObj = (arr, arrType = '_1D_Arr') => {
	let obj = {};
	switch (arrType) {
		case '_2D_Arr':
